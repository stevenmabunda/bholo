...
>(
  (
    ...
    return (
      <div
        ref={ref}
        className={cn("group hidden h-full md:flex md:flex-col text-sidebar-foreground", className)}
        data-state={state}
      ...
      >
        <div
            data-sidebar="sidebar"
            className="flex h-full w-[--sidebar-width] flex-col transition-[width] ease-linear group-data-[collapsible=icon]:w-[--sidebar-width-icon]"
          >
            {children}
          </div>
      </div>
